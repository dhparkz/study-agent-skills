...
> **The Complete Guide to Building Skills for Claude** 의 비공식 한국어 번역본입니다.
...
- 설명 텍스트는 **자연스러운 한국어**로 번역
- 코드 블록, 명령어, 파일명, 경로, URL, 제품명 등 기술적 식별자는 **원문 그대로** 유지
- 각 챕터별 커버 이미지 포함
...
.
├── README.md
├── The-Complete-Guide-to-Building-Skill-for-Claude.pdf   # 원본 PDF
├── chapters/                # 챕터별 한국어 번역 마크다운
│   ├── 00-소개.md
│   ├── 01-기초.md
│   ├── 02-기획-및-설계.md
│   ├── 03-테스트와-반복-개선.md
...
└── covers/                  # 챕터별 커버 이미지
    ├── 00-cover.png
    ├── 01-fundamentals.png
    ├── 02-planning_and_design.png
    ├── 03-testing_and_iteration.png
    ├── 04-distribution_and_sharing.png
    ├── 05-patterns_and_trobuleshooting.png
    └── 06-resources_and_refrences.png
```

## 원본 출처

- **원문**: [The Complete Guide to Building Skills for Claude](https://claude.com/blog/skills) (Anthropic)
- **공식 스킬 문서**: https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview
- **예시 스킬 레포**: https://github.com/anthropics/skills

## 라이선스

이 번역본은 교육 목적으로 제작되었습니다. 원본 저작권은 Anthropic에 있습니다.
